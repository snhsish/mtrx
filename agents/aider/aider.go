...
func (a *Adapter) Collect(ctx context.Context, src agents.Source) ([]events.Event, error) { return nil, nil }
func (a *Adapter) Watch(ctx context.Context, src agents.Source, emit func(events.Event)) error { <-ctx.Done(); return nil }
